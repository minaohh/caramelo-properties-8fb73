...
sections:
  - title: B2 Townhouse
    ...
    content: >
      ##### Spacious 3 BR, 3 Bathroom, 2-Storey Townhouse with Netflix, 50 MBPS
      Fiber WiFi, Cable TV, Parking (2 cars), and Balcony
    ...
    actions:
      - label: Book Directly
        ...
        type: action
      - label: Airbnb
        url: 'https://bit.ly/CPTownhouseB2'
        style: primary
        has_icon: true
        icon: arrow-right
        icon_position: right
        ...
        type: action
      - label: Booking.com
        url: 'https://bit.ly/Caramelo_BookingDotCom'
        style: secondary
        has_icon: true
        icon: arrow-right
        icon_position: right
    ...
    grid_items:
      ...
      - title: Balcony
        ...
        content: |
          ...
          *   Perfect for early-morning stretches and late-night talks
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
      ...
      - title: Parking Area
        ...
        content: |
          ...
          *   Patio w/ outdoor furniture for seating
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
    ...
    grid_items:
      ...
      - title_align: left
        content: >
          ...
          **Nathaniel**, *booked via Airbnb, April 2021*
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
